...
export const GAME_VARIANTS: VariantMeta[] = [
  ...
  { id: 'misere_ttt',   name: 'Misère',         description: 'Force your opponent to get 3-in-a-row to win.',            allowPrivate: true, allowCasual: true, allowRated: false },
  { id: 'notakto_ttt',  name: 'Notakto',        description: 'Both players place X. Avoid making 3-in-a-row!',           allowPrivate: true, allowCasual: true, allowRated: false },
  { id: 'wild_ttt',     name: 'Wild',           description: 'Choose to place X or O on every turn.',                    allowPrivate: true, allowCasual: true, allowRated: false },
  { id: 'sos_ttt',      name: 'SOS',            description: 'Place S or O to spell S-O-S for points + extra turns.',    allowPrivate: true, allowCasual: true, allowRated: false },
  { id: 'numerical_ttt',name: 'Numerical',      description: 'Place numbers to sum precisely to 15.',                    allowPrivate: true, allowCasual: true, allowRated: false },
  { id: 'vanishing_ttt',name: 'Vanishing',      description: 'Pieces disappear after 6 moves. Memory counts.',           allowPrivate: true, allowCasual: true, allowRated: false },
  ...
  { id: 'ttt_4d',       name: '4D TTT',         description: '3×3×3×3 hypercube. Four dimensions of strategy.',          allowPrivate: true, allowCasual: true, allowRated: false },
